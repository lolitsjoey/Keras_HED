...
class DataParser():
    def __init__(self, batch_size_train):
        self.train_file = os.path.join('./MM-stuff/', 'train_pair.lst')
        self.train_data_dir = './classifier_train_station/'
        ...
        self.all_ids = os.listdir('./classifier_train_station/train_images')
