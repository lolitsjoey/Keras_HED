...
def hed(weights_file):
    ...
    x = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='block5_pool')(x)# 60 60 256
    ...
    b6 = side_branch(x, 32)  # 480 480 1
    x = MaxPooling2D((2, 2), strides=(2, 2), padding='same', name='block6_pool')(x)

# 60 60 256

    # fuse
    fuse = Concatenate(axis=-1)([b1, b2, b3, b4, b5, b6])
    ...
    o6    = Activation('sigmoid', name='o6')(b6)
    ofuse = Activation('sigmoid', name='ofuse')(fuse)


    # model
    model = Model(inputs=[img_input], outputs=[o1, o2, o3, o4, o5, o6, ofuse])
