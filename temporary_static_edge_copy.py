...
def main(rgb_image_feat, scores_df):
    ...
    load_classifier_weights_dir = './wedcwecwecw.h5'
    ...
    img_folder_to_classify = ['D:/scoring_and_profiling/StripeCrop_aug/', 'D:/scoring_and_profiling/StripeCropBridge_aug/']
    img_folder_to_test_classifier = ['D:/scoring_and_profiling/StripeCrop_aug/', 'D:/scoring_and_profiling/StripeCropBridge_aug/']
...
def get_dense_output(dense_df, img_folder_to_classify, model, layer_name, imShape = (480,480), write = False, edge=False, dct=False, TEMP=False, lbp_class=None):
    ...
    for idx, img in enumerate(os.listdir(img_folder_to_classify[0])):
        ...
        if TEMP:
            ...
            test_img = cv2.resize(cv2.imread(img_folder_to_classify[1] + img, 0), imShape)
